	...
	<jsp:body>
		<t2:layoutTable>
			...
			<jsp:attribute name="content">
				...
				<div>
					<a href="javascript:;" type="button" class="btn btn-primary iconBtn upload">
						<i class="icon"></i>
						<b>Upload Files</b>
					</a>
					...
					<table class="table uploadTable" cellspacing="0" cellpadding="0" border="1">
						<tr class="tableHdr">
							<th>Job Id</th>
						...
						<c:forEach var="job" items="${uploadsResponse.jobs}">
						
							<tbody>
								<tr class="q-folderRow">
									<td>${job.jobId}</td>
									<td>
										<%--=============================
										Uploaded files
